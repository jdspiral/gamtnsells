<?php
/**
 * Based off the Genesis Featured Post widget
 *
...
/**
 * Winning Agent Pro Featured Community widget class.
 *
 * @since 1.0.0
 */
class Winning_Agent_Pro_Featured_Community extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __( 'Displays featured communities with thumbnails', 'wap' ),
		);
		...
		parent::__construct( 'featured-community', __( 'Featured Communities', 'wap' ), $widget_ops, $control_ops );
